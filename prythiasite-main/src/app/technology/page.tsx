  ...
  return (
    <SiteShell>
      <section className="grid gap-6">
        <p className="text-xs uppercase tracking-[0.3em] text-[rgba(247,215,76,0.8)]">Technology</p>
      ...
      <section className="grid gap-8 rounded-3xl border border-[rgba(247,215,76,0.2)] bg-[rgba(12,13,20,0.9)] p-8">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-[rgba(247,215,76,0.8)]">Architecture</p>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {architecture.map((layer) => (
            <div key={layer.label} className="rounded-2xl bg-[rgba(6,7,10,0.75)] p-5">
              <p className="text-xs uppercase tracking-[0.24em] text-zinc-500">{layer.label}</p>
